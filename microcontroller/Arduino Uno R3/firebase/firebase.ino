...
#define WIFI_SSID "Home 98"
#define WIFI_PASSWORD "home@123"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyA7g-THYRBBmTHneyZ2IE6BOrmhTnAaOS8"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://gdsc-hackathon-2024-52353-default-rtdb.asia-southeast1.firebasedatabase.app/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
